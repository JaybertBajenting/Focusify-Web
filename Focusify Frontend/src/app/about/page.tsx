  ...
  return (
    <div className="max-w-[1920px] pl-[50px] pr-[50px] mx-auto">
      ...
      <div className="flex justify-between ml-[75px] mr-[75px]">
        ...
        <div className="space-y-[15px]  w-[600px] h-[300px] mt-[100px]">
          <h1 className="font-bold  text-[20px]">
            Different types of music for a Conductive Study Environment
          </h1>
          <p className="text-[18px]">
            Our app uses our built in Music Player, <br />
            providing students with the ability to listen to focus music with different genres to satisfy their needs <br />
