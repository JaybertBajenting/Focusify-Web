    ...
    <div className="max-w-[1920px] min-w-[500px] mx-[auto] pl-[50px] pr-[50px]">
      ...
      <div className="mt-[100px] flex justify-between bg-musicNote">
        <div className="space-y-5">
          ...
          <p>
            Experience the Power of Customizable Timers and our built in music player
          </p>
        ...
        <Image src="/images/pic3.png" alt="" width={600} height={400} />
      </div>
      ...
      <div className="mt-[150px] space-y-5">
        ...
        <p className="text-center">
          ...
          improve productivity with customizable timers and a music feature from our playlist.
        </p>
      </div>
      <div className="flex justify-between mt-[150px] space-x-10">
        <div>
          <Image src="/images/pic4.png" alt="" width={482} height={251} />
          <p className="text-center">Customizable Timers</p>
        </div>
        <div>
          <Image src="/images/pic5.png" alt="" width={482} height={251} />
          <p className="text-center">Music Feature</p>
        </div>
        <div>
          <Image src="/images/pic6.png" alt="" width={482} height={251} />
